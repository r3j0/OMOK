...
/*
	(( OMOK )) Author : r3j0
	Last Backup : 2022-05-26 PM 08:00
*/
		...
		while (1) {
			...
			while (!feof(fp)) {
				...
				if (!strcmp(read_str_comp, now_rec)) {
					...
					int firsty10 = read_str[now_rec_size_comp + 3] - '0';
					int firsty1 = read_str[now_rec_size_comp + 4] - '0';
					int firstx10 = read_str[now_rec_size_comp + 5] - '0';
					int firstx1 = read_str[now_rec_size_comp + 6] - '0';
